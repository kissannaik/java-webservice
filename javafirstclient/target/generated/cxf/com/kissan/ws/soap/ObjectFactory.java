 ...
 * generated in the com.kissan.ws.soap package. 
...
public class ObjectFactory {
    ...
    private final static QName _ProcessPayment_QNAME = new QName("http://soap.ws.kissan.com/", "processPayment");
    private final static QName _ProcessPaymentResponse_QNAME = new QName("http://soap.ws.kissan.com/", "processPaymentResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.kissan.ws.soap
     * 
     */
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.kissan.com/", name = "processPayment")
     ...
     */
    @XmlElementDecl(namespace = "http://soap.ws.kissan.com/", name = "processPaymentResponse")
